...
{
    /// <summary>
    /// Create a timer that updates every Unity update using Time.deltaTime. Has events for every update and on completion. Useful for cases where you don't need to create a timer setup for your monobehaviour using an unnecessary update function.
    /// </summary>
