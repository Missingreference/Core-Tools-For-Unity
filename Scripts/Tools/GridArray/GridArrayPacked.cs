...
namespace Elanetic.Tools
{
    ...
    public class GridArrayPacked<T>
    {
        ...
        /// <summary>
        /// Output the the array for debugging purposes.
        /// </summary>
        /// <returns></returns>
        public string PrintArray()
        {
            StringBuilder sBuilder = new StringBuilder();
            sBuilder.Append("Item Count: ");
            ...
            for(int i = 0; i < count; i++)
            {
                ...
                sBuilder.Append("][");
                sBuilder.Append(m_Array[i].gridIndex.ToString());
                sBuilder.Append(" => ");
                sBuilder.Append(m_Array[i].item.ToString());
                sBuilder.Append("]\n");
            }
